...
# --- Configuration ---
DATA_DIR = 'data/10apr/' # Or your correct data path
...
RESULTS_FILE = 'stage1_grid_search_WH_results.csv' # Results file for Stage 1 Grid Search
DEFAULT_MODEL_SAVE_PATH = 'predictive_model_xgb_s1.joblib' 
DEFAULT_FEATURE_COLS_SAVE_PATH = 'feature_columns_xgb_s1.joblib' 
STAGE1_PREDICTIONS_OUTPUT_FILE = 'stage1_predictions.csv' # Output for Stage 2
